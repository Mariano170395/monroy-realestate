    ...
    <div>
      ...
      <div className="WrapperCatalogo">
      {
        images.filter(image=>{
          ...
          image.estatus === 'Renta' && image.colonia.includes(busqueda) && (image.banos ===  parseInt(baños)|| baños === '') && (image.habitaciones ===  parseInt(habitaciones)|| habitaciones === '')  && (precioMin === '' || image.precio >= parseInt(precioMin)) && (image.precio <= parseInt(precioMax) || precioMax === '') ? (

          <div  onClick={()=>history.push(`/rentar/${image._id}`)} key={image._id}>
